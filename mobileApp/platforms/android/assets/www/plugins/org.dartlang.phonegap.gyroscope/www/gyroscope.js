cordova.define("org.dartlang.phonegap.gyroscope.gyroscope", function(require, exports, module) {
...
var argscheck = require('cordova/argscheck'),
    ...
    Acceleration = require('./AngularSpeed');

// Is the gyroscope sensor running?
var running = false;

// Keeps reference to watchAngularSpeed calls.
var timers = {};
...
function start() {
    exec(function(a) {
        ...
        speed = new AngularSpeed(a.x, a.y, a.z, a.timestamp);
...
var gyroscope = {
     ...
     */
    getCurrentAngularSpeed: function(successCallback, errorCallback, options) {
        argscheck.checkArgs('fFO', 'gyroscope.getCurrentAngularSpeed', arguments);
     ...
     */
    watchAngularSpeed: function(successCallback, errorCallback, options) {
        argscheck.checkArgs('fFO', 'gyroscope.watchAngularSpeed', arguments);
     ...
     *
     * @param {String} id       The id of the watch returned from #watchAngularSpeed.
     */
